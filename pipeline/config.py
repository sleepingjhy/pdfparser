...
class ApiConfig:
    ...
    poll_timeout_pause_minutes: int = 20  # 轮询超时后暂停的分钟数
...
def _merge_config(cfg: AppConfig, raw: dict) -> None:
    ...
    cfg.api.poll_timeout_pause_minutes = api_raw.get(
        "poll_timeout_pause_minutes", cfg.api.poll_timeout_pause_minutes
    )
